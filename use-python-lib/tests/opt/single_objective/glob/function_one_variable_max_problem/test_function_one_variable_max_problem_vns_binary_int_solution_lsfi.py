...
class TestMaxFunctionOneVariableMaxProblemBinaryIntSolutionLsfi(unittest.TestCase):
    ...
    def setUpClass(cls):
        print(
            "setUpClass TestIntegrationFunctionOneVariableMaxProblemBinaryIntSolutionLsbi\n"
        )
    ...
    def test_best_solution_after_optimization_should_be_all_optimal(self):
        # Act
        result = 0.0
        arg = self.optimizer.best_solution.argument(
            self.optimizer.best_solution.representation
        )
        # Assert
    ...
    def test_best_solution_after_optimization_should_have_optimal_objective_value(self):
        ...
        self.assertLessEqual(
            abs(self.optimizer.best_solution.objective_value - result), 0.3
        )

    def test_best_solution_after_optimization_should_have_optimal_fitness_value(self):
        result = 7.0
        self.assertLessEqual(
            abs(self.optimizer.best_solution.fitness_value - result), 0.3
        )
