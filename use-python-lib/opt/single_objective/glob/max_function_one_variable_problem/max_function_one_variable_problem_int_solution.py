...
class FunctionOneVariableMaxProblemIntSolution(Solution[int,float]):
    ...
    def obtain_feasible_representation(self, problem:MaxFunctionOneVariableMaxProblem):
    ...
    def init_from(self, representation:int, problem:MaxFunctionOneVariableMaxProblem)->None:
