...
class MinSetCoverProblem(Problem):
    """
    ...
    Methods:
        __init__(universe: Set[int], subsets: list[Set[int]]): Initializes a new instance of the MinSetCoverProblem class.
        ...
        from_input_files(universe_file_path: str, subsets_file_path: str): Creates a new MinSetCoverProblem instance when the input file and input format are specified.
        __copy__() -> MinSetCoverProblem: Internal copy of the MinSetCoverProblem problem.
        copy() -> MinSetCoverProblem: Copy the MinSetCoverProblem problem.
        ...
        string_rep(delimiter: str, indentation: int = 0, indentation_symbol: str = '', group_start: str = '{', group_end: str = '}') -> str: String representation of the MinSetCoverProblem instance.
        __str__() -> str: String representation of the MinSetCoverProblem structure.
        __repr__() -> str: Representation of the MinSetCoverProblem instance.
        __format__() -> str: Formatted MinSetCoverProblem instance.
    """

    def __init__(self, universe:Set[int], subsets:list[Set[int]])->None:
        """
        Create new `MinSetCoverProblem` instance
        ...
        if not isinstance(universe, set):
            raise TypeError('Parameter \'universe\' for  MinSetCoverProblem should be a \'set\'.')
        if not isinstance(subsets, list):
            raise TypeError('Parameter \'subsets\' for  MinSetCoverProblem should be \'list\'.')
        super().__init__(name="MinSetCoverProblem", is_minimization=True, is_multi_objective=False)
    ...
    @classmethod
    def from_input_files(cls, universe_file_path: str, subsets_file_path: str)->'MinSetCoverProblem':
        """
        ...
        """
        result:tuple = MinSetCoverProblem.__load_from_file__(universe_file_path, subsets_file_path)
