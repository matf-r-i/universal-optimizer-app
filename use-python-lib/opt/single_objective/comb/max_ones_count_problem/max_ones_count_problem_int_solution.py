...
The :mod:`~opt.single_objective.comb.ones_count_max_problem.ones_count_max_problem_int_solution` contains class :class:`~opt.single_objective.comb.ones_count_max_problem.ones_count_max_problem_int_solution.MaxOnesCountProblemIntSolution`, that represents solution of the :ref:`Problem_Ones_Count_Max`, where `int` representation of the problem has been used.
"""
...
class MaxOnesCountProblemIntSolution(Solution[int,str]):
    ...
    def __init__(self,random_seed:Optional[int]=None, 
        ...
        """
        Create new `MaxOnesCountProblemIntSolution` instance
    ...
    def init_random(self, problem:MaxOnesCountProblem)->None:
        """
