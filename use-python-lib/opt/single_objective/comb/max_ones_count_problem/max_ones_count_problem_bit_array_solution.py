...
class MaxOnesCountProblemBitArraySolution(Solution[BitArray,str]):
    ...
    def __init__(self, random_seed:Optional[int]=None, 
        ...
        """
        Create new `MaxOnesCountProblemBitArraySolution` instance
        """
    ...
    def copy(self):
        """
        Internal copy of the `MaxOnesCountProblemBitArraySolution`
        ...
        """
        sol = MaxOnesCountProblemBitArraySolution(self.random_seed)
        sol.copy_from(self)
        return sol
