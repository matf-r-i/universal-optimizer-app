...
class OnesCountMaxProblemBinaryIntSolutionVnsLsSupportFI(VnsLocalSearchSupport[int,str]):
    
    def __init__(self)->None:
        """
        Create new `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportFI` instance
        """
        return

    def __copy__(self):
        """
        Internal copy of the `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportFI`

        :return: new `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportFI` instance with the same properties
        :rtype: OnesCountMaxProblemBinaryIntSolutionVnsLsSupportFI
        """
        sup = deepcopy(self)
        return sup
    ...
    def copy(self):
        """
        Copy the `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportFI`
    ...
    def string_rep(self, delimiter:str, indentation:int=0, indentation_symbol:str='', group_start:str ='{', 
        ...
        :rtype: str
        """        
        return 'OnesCountMaxProblemBinaryIntSolutionVnsLsSupportFI'
