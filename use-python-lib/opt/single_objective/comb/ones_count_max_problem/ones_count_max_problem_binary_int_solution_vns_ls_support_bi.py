...
class OnesCountMaxProblemBinaryIntSolutionVnsLsSupportBI(VnsLocalSearchSupport[int,str]):
    
    def __init__(self)->None:
        """
        Create new `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportBI` instance
        """
        return

    def __copy__(self):
        """
        Internal copy of the `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportBI`

        :return: new `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportBI` instance with the same properties
        :rtype: OnesCountMaxProblemBinaryIntSolutionVnsLsSupportBI
        """
        sup = deepcopy(self)
        return sup
    ...
    def copy(self):
        """
        Copy the `OnesCountMaxProblemBinaryIntSolutionVnsLsSupportBI`
    ...
    def local_search(self, k:int, problem:OnesCountMaxProblem, solution:OnesCountMaxProblemBinaryIntSolution, 
    ...
    def string_rep(self, delimiter:str, indentation:int=0, indentation_symbol:str='', group_start:str ='{', 
        ...
        :rtype: str
        """        
        return 'OnesCountMaxProblemBinaryIntSolutionVnsLsSupportBI'
