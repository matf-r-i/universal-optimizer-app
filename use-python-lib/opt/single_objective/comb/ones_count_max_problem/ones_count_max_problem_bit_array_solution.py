...
The :mod:`~opt.single_objective.comb.ones_count_max_problem.ones_count_max_problem_bit_array_solution` contains class :class:`~opt.single_objective.comb.ones_count_max_problem.ones_count_max_problem_bit_array_solution.OnesCountMaxProblemBitArraySolution`, that represents solution of the :ref:`Problem_Ones_Count_Max`, where `BitArray` representation of the problem has been used.
"""
import sys
import os
...
class OnesCountMaxProblemBitArraySolution(Solution[BitArray,str]):
    ...
    def __init__(self, random_seed:Optional[int]=None, 
        ...
        """
        Create new `OnesCountMaxProblemBitArraySolution` instance
        """
    ...
    def copy(self):
        """
        Internal copy of the `OnesCountMaxProblemBitArraySolution`

        :return: new `OnesCountMaxProblemBitArraySolution` instance with the same properties
        :rtype: OnesCountMaxProblemBitArraySolution
        """
        sol = OnesCountMaxProblemBitArraySolution(self.random_seed)
        sol.copy_from(self)
        return sol
