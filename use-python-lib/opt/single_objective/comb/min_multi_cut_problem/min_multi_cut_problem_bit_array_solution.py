...
class MinMultiCutProblemBitArraySolution(Solution[BitArray,str]):
    ...
    def __init__(self, random_seed:Optional[int]=None, 
        ...
        """
        Create new `MinMultiCutProblemBitArraySolution` instance
        """
    ...
    def calculate_quality_directly(self, representation:BitArray, 
            problem:MinMultiCutProblem)->QualityOfSolution:
        """
