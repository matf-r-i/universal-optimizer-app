...
def main():
    ...
    ga_cross_support: GaCrossoverSupportOnePointBitArray[str] = GaCrossoverSupportOnePointBitArray[str](
        crossover_probability=0.999)
    ga_mut_support: GaMutationSupportOnePointBitArray[str] = GaMutationSupportOnePointBitArray(
    ...
    optimizer: GaOptimizerGenerational = GaOptimizerGenerational.from_construction_tuple(
