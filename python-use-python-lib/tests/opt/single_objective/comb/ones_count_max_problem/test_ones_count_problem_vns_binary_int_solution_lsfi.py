...
class TestOnesCountMaxProblemVnsBinaryIntSolutionLsfi(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        print("setUpClass TestIntegrationOnesCountMaxProblemVnsBinaryIntSolutionLsfi\n")
    ...
    def setUp(self):
        ...
        self.finish_control: FinishControl = FinishControl(
            criteria='evaluations', evaluations_max=5000)
        self.vns_ls_support: VnsLocalSearchSupportStandardFirstImprovementInt[int] = VnsLocalSearchSupportStandardFirstImprovementInt[int](
            dimension=dimension)
        self.vns_shaking_support: VnsShakingSupportStandardInt[int] = VnsShakingSupportStandardInt[int](dimension=dimension)
    ...
    def tearDownClass(cls):
        print("\ntearDownClass TestIntegrationOnesCountMaxProblemVnsBinaryIntSolutionLsfi")
