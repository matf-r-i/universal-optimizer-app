...
class TestIntegrationOnesCountMaxProblemGaBitArraySolution(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.finish: FinishControl = FinishControl(
    ...
    def test_returned_best_solution_is_equal_to_optimizer_best_solution(self):
        self.assertEqual(self.bs.string_representation(),
                         self.optimizer.best_solution.string_representation())
