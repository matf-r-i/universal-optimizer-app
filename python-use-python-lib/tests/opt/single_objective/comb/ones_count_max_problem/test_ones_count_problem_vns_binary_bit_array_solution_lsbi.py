...
class TestOnesCountMaxProblemVnsBinaryBitArraySolutionLsbi(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.finish_control: FinishControl = FinishControl(
            criteria='evaluations', evaluations_max=1000, iterations_max=0, seconds_max=0)
        ...
        self.vns_ls_support: VnsLocalSearchSupportStandardBestImprovementBitArray[
            int] = VnsLocalSearchSupportStandardBestImprovementBitArray[int](dimension=dimension)
