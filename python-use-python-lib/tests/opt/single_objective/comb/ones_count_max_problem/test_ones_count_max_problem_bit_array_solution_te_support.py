...
class TestOnesCountMaxProblemBitArraySolutionTeSupport(unittest.TestCase):
    ...
    def test_reset_internal_counter_and_state(self):
        ...
        self.assertEqual(te_support._TeOperationsSupportBitArray__bit_array_counter.current_state(
        ), BitArray(bin=result))
