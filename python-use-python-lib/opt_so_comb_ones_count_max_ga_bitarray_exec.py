...
def main():
    ...
    ga_crossover_support: GaCrossoverSupportOnePointBitArray[str] = GaCrossoverSupportOnePointBitArray[str](
        crossover_probability=0.95)
    ga_mutation_support: GaMutationSupportOnePointBitArray = GaMutationSupportOnePointBitArray[str](
