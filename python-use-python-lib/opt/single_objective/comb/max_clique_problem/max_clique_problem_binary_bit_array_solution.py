...
class MaxCliqueProblemBitArraySolution(Solution[BitArray,str]):
    ...
    def init_random(self, problem:MaxCliqueProblem)->None:
        """
        ...
        self.representation = BitArray(len(problem.graph.nodes))
