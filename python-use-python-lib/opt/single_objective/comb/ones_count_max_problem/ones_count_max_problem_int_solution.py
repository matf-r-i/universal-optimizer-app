...
The :mod:`~opt.single_objective.comb.ones_count_max_problem.ones_count_max_problem_int_solution` contains class :class:`~opt.single_objective.comb.ones_count_max_problem.ones_count_max_problem_int_solution.OnesCountMaxProblemIntSolution`, that represents solution of the :ref:`Problem_Ones_Count_Max`, where `int` representation of the problem has been used.
"""
...
class OnesCountMaxProblemIntSolution(Solution[int,str]):
    ...
    def __init__(self,random_seed:Optional[int]=None, 
        ...
        """
        Create new `OnesCountMaxProblemIntSolution` instance
    ...
    def copy(self):
        obj = OnesCountMaxProblemIntSolution(self.random_seed)
        obj.copy_from(self)
        return obj
