...
def main():
    ...
    finish: FinishControl = FinishControl(
        criteria='evaluations & seconds', evaluations_max=1000, seconds_max=3)
    vns_shaking_support: VnsShakingSupportStandardBitArray[str] = VnsShakingSupportStandardBitArray[str](
        dimension=problem_dimension)
    vns_ls_support: VnsLocalSearchSupportStandardBestImprovementBitArray[str] = VnsLocalSearchSupportStandardBestImprovementBitArray[str](
        dimension=problem_dimension)
