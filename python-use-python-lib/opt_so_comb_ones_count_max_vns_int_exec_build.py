...
class OnesCountMaxProblem2(Problem):
    ...
    def __init__(self, dim: int = 10) -> None:
        ...
        super().__init__("OnesCountMaxProblem2",
                         is_minimization=False, is_multi_objective=False)

    def copy(self):
        pr = OnesCountMaxProblem2(self.dimension)
        return pr
...
class OnesCountMaxProblemIntSolution(Solution[int, str]):
    ...
    def copy(self):
        sol = OnesCountMaxProblemIntSolution(self.random_seed)
        return sol
...
class OnesCountMaxProblemIntSolutionVnsShakingSupport(VnsShakingSupport[int, str]):
    ...
    def copy(self):
        sup = OnesCountMaxProblemIntSolutionVnsShakingSupport()
        return sup
...
class OnesCountMaxProblemIntSolutionVnsLocalSearchSupport(VnsLocalSearchSupport[int, str]):
    ...
    def copy(self):
        sup = OnesCountMaxProblemIntSolutionVnsLocalSearchSupport()
        return sup
    ...
    def local_search_first_improvement(self, k: int, problem: OnesCountMaxProblem2, solution: OnesCountMaxProblemIntSolution,
        ...
        if k < 1:
            return False
        # ls_fi for k==1
        start_sol: OnesCountMaxProblemIntSolution = OnesCountMaxProblemIntSolution()
...
def main():
    ...
    finish: FinishControl = FinishControl(
        criteria='evaluations & seconds', evaluations_max=500, seconds_max=10)
    vns_shaking_support: OnesCountMaxProblemIntSolutionVnsShakingSupport = OnesCountMaxProblemIntSolutionVnsShakingSupport()
    vns_ls_support: OnesCountMaxProblemIntSolutionVnsLocalSearchSupport = OnesCountMaxProblemIntSolutionVnsLocalSearchSupport()
    ...
    optimizer: VnsOptimizer = VnsOptimizer.from_construction_tuple(
